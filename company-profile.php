...
<head>
    ...
    <title>Company Profile | Unique Wire Netting</title>
    <!-- Fonts -->
    <link
...
<body>
    ...
    <section class="page-header about-header">
        <div class="container">
            ...
            <h1 class="page-title">Engineering High-Tensile Solutions<br>Since 2008</h1>
        ...
        <div class="container">
            ...
            <div class="summary-grid">
                <div class="summary-main">
                    ...
                    <p>
                        Established in 2008, we have dedicated 17+ years to perfecting the engineering of
        ...
        <div class="container">
            <div class="corp-box">
                <div class="corp-text">
                    ...
                    <p>We adhere to stringent quality management protocols, ensuring
                        that every square meter of mesh leaving our facility maintains absolute engineering integrity.
                    </p>
                </div>
                <div class="corp-details">
                    ...
                    <div class="detail-item">
                        ...
                        <span class="detail-value">SS 304, 316, 316L, G.I., M.S, Carbon Steel</span>
                    </div>
                    <div class="detail-item">
