...
<head>
    ...
    <title>Unique Wire Netting | Premium Wire Mesh & Netting Manufacturer</title>
    <meta name="description"
        content="Unique Wire Netting - Leading manufacturer of premium wire mesh, stainless steel cable mesh, and industrial netting solutions for architectural and civil contracting needs.">
    <!-- Fonts -->
    <link
...
<body>
        ...
        <div class="container hero-content">
            <div class="hero-text-box">
                ...
                <p class="hero-description">
                    ...
                    for premier civil contractors worldwide.
                </p>
                <div class="hero-btns">
                    <a href="flexible-ss-cable-mesh.php" class="btn btn-accent">Explore Solutions</a>
                    <a href="contact.php" class="btn btn-outline"
                        style="border-color: var(--white); color: var(--white);">Consult an Expert</a>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="about-grid">
                ...
                <div class="about-text">
                    <h4 class="section-subtitle">The Industry Standard</h4>
                    <h2 class="section-title">Sophisticated Engineering. Reliable Protection.</h2>
                    <p>
                        Unique Wire Netting is a premier manufacturer and exporter specializing in high-performance wire
                        mesh solutions. Our products are engineered for extreme durability, serving the demands of
                        modern architecture, wildlife conservation, and industrial safety.
                    </p>
                    <p>
                        With state-of-the-art facilities and a commitment to international quality standards, we provide
                        civil contractors with the precision required for world-class projects.
                    </p>
                    <div class="about-features">
                        <div class="feature">
                            <i class="fas fa-check-circle"></i>
                            <span>SS316 Marine Grade Quality</span>
                        </div>
                        <div class="feature">
                            <i class="fas fa-check-circle"></i>
                    ...
                    <a href="about.php" class="btn btn-outline">Our Technical Legacy</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <!-- Product Categories -->
    <section class="sectioncategories-home" style="background-color: var(--bg-alt);">
        <div class="container">
        ...
        <div class="container">
            <div class="app-header">
                <div class="header-text">
                    <h4 class="section-subtitle" style="color: var(--accent);">Versatile Protection</h4>
                    <h2 class="section-title" style="color: var(--white);">Industrial & Architectural Applications</h2>
                </div>
